...
class DebugManager:
    ...
    def __init__(self):
        self.debug_mode = True  # Default: debug mode active
        self.font = None
        self.fps_counter = 0
        self.fps_timer = 0
        self.current_fps = 0
...
class DesktopPetApp:
    ...
    def __init__(self):
        ...
        self.debug_manager = DebugManager()  # NEW: Debug manager
    ...
    def _print_controls(self):
        ...
        print("  F1: Toggle debug mode")  # NEW: Debug toggle
        print("  ESC: Exit")
        ...
        print("🐛 Debug Features:")  # NEW: Debug info
    ...
    def handle_events(self):
        ...
        for event in pygame.event.get():
            if event.type == pygame.QUIT:
                ...
                elif event.key == pygame.K_F1:  # NEW: Debug toggle
    ...
    def render(self):
        ...
        if self.debug_manager.should_show_boundaries() and self.boundary_manager:
